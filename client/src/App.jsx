...
const LibraryPage = DelayLoader(() => import("./Pages/LibraryPage/LibraryPage"));
const BookStorePage = DelayLoader(() => import("./Pages/BookStorePage/BookStorePage"));
...
const UserHomePage = DelayLoader(() => import("./User/UserDashboardPages/UserHomePage/UserHomePage"));
const UserLibraryPage = DelayLoader(() => import("./User/UserDashboardPages/UserLibraryPage/UserLibraryPage"));
const UserTrendPage = DelayLoader(() => import("./User/UserDashboardPages/UserTrendPage/UserTrendPage"));
const UserPurchasePage = DelayLoader(() => import("./User/UserDashboardPages/UserPurchasePage/UserPurchasePage"));
const UserSubPage = DelayLoader(() => import("./User/UserDashboardPages/UserSubPage/UserSubPage"));
const UserProfilePage = DelayLoader(() => import("./User/UserDashboardPages/UserProfilePage/UserProfilePage"));
const UserNotificationPage = DelayLoader(() => import("./User/UserDashboardPages/UserNotificationPage/UserNotificationPage"));
const UserHelpPage = DelayLoader(() => import("./User/UserDashboardPages/UserHelpPage/UserHelpPage"));
const UserOTP = DelayLoader(() => import("./User/UserDashboard/UserOTP/UserOTP"));

// Admin Dashboard Pages
const AdminHomePage = DelayLoader(() => import("./Admin/AdminDashboardPages/AdminHomePage/AdminHomePage"));
const AdminUserPage = DelayLoader(() => import("./Admin/AdminDashboardPages/AdminUserPage/AdminUserPage"));
const AdminBookPage = DelayLoader(() => import("./Admin/AdminDashboardPages/AdminBookPage/AdminBookPage"));
const AdminTransactionPage = DelayLoader(() => import("./Admin/AdminDashboardPages/AdminTransactionPage/AdminTransactionPage"));
const AdminNotificationPage = DelayLoader(() => import("./Admin/AdminDashboardPages/AdminNotificationPage/AdminNotificationPage"));
const AdminProfilePage = DelayLoader(() => import("./Admin/AdminDashboardPages/AdminProfilePage/AdminProfilePage"));
const AdminAuth = DelayLoader(() => import("./Admin/AdminDashboard/AdminAuth/AdminAuth"));
...
function App() {
  ...
  const hiddenRoutes = [
    "/authentication", "/userdashboard/home",
