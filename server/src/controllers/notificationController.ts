...
exports.getAllNotificationsByUserId = async (req: any, res: any) => {
  try {
    const { id } = req.user;
...
exports.markViewedNotifications = async (req: any, res: any) => {
  try {
...
exports.deleteNotification = async (req: any, res: any) => {
  try {
    const { notification_id } = req.params;
    const { id } = req.user;
